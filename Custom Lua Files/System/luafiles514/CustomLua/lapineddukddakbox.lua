	...
	sources = {
		...
		CustomDukBox = { -- Item Name in Database or just in lua file
			...
			SourceItems = { -- List of possible materials
				{ "Either File Name, Item DB Entry or just a item name for overview", <Min amount per exchange>, <Item ID> }
			},
		...
		CustomDukBox = {
			...
			NeedRefineMax = 10,
			SourceItems = {
				{ "SimpleItemDisplay", 1, 35000 },
				{ "SimpleItemDisplay", 1, 35001 },
				{ "SimpleItemDisplay", 1, 35002 }
			},
