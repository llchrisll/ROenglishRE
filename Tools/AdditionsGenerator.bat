...
:SysLua
	...
	echo [2] ChangeMaterial_EN.lub (2022-12-07 and newer) %sys_c[2]%
	...
	if %sys% equ 1 (
		...
		if %date% leq 20170614 (
			xcopy "%sourceSystemPath%\monster_size_effect_EN 20170614.lub" "%destinationSystemPath%\monster_size_effect_EN.lub"* /H /C /I /Y
		) else (
