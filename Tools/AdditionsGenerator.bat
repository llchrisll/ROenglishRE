...
:DataMenu
	...
	if %data%==1 (
		xcopy "..\Additions\data\bookitemnametable.txt" ".\Client\data\bookitemnametable.txt"* /E /H /C /Y
...
:DataLua
	...
	if %lua%==1 (
		xcopy "..\Additions\data\luafiles514\" ".\Client\data\luafiles514\" /E /H /C /I /Y
		set lua_c[0]=Copied
	)
	if %lua%==2 (
