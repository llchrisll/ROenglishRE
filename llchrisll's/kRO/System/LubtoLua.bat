@echo off
luadec.exe achievement_list.lub > achievement_list.lua
luadec.exe CheckAttendance.lub > CheckAttendance.lua
luadec.exe itemInfo.lub > itemInfo.lua
luadec.exe itemInfo_indoor.lub > itemInfo_indoor.lua
luadec.exe itemInfo_Sak.lub> itemInfo_Sak.lua
luadec.exe itemInfo_true.lub> itemInfo_true.lua
luadec.exe mapInfo_sak.lub > mapInfo_sak.lua
luadec.exe mapInfo_true.lub > mapInfo_true.lua
luadec.exe monster_size_effect.lub > monster_size_effect.lua
luadec.exe monster_size_effect_new.lub > monster_size_effect_new.lua
luadec.exe monster_size_effect_sak.lub > monster_size_effect_sak.lua
luadec.exe monster_size_effect_sak_new.lub > monster_size_effect_sak_new.lua
