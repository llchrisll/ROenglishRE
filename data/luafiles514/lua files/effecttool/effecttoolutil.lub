...
ReadTable = function(InfoTableName, effectId)
...
IsOpenedEffectFiles = function(InfoTableName)
...
ReadOtherTable = function(InfoTableName)
	local t = _G[InfoTableName]
	for i = 0, table.getn(t), 1 do
...
ReadEffectInfoz = function(InfoTableName)
	local EffectInfoTable = _G[InfoTableName]
	if EffectInfoTable ~= nil then
